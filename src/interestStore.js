...
exports.INTEREST_FILE_PATH = `${__dirname}/../interest.json`;


exports.getInterest = () => {
	if (!existsSync(exports.INTEREST_FILE_PATH)) {
		return DEFAULT_INTEREST_RATE;
	}
	return JSON.parse(readFileSync(exports.INTEREST_FILE_PATH, 'utf8')).interestRate;
};

exports.updateInterest = (interestRate) => {
	writeFileSync(exports.INTEREST_FILE_PATH, JSON.stringify({interestRate}), 'utf8');
};
